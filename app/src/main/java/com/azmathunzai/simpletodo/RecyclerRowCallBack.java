...
public class RecyclerRowCallBack extends ItemTouchHelper.Callback {
    private RecyclerViewRowTouchHelperContract touchHelperContract;

    public RecyclerRowCallBack(RecyclerViewRowTouchHelperContract touchHelperContract) {
    ...
    public void onSelectedChanged(@Nullable RecyclerView.ViewHolder viewHolder, int actionState) {
        ...
        if (actionState != ItemTouchHelper.ACTION_STATE_IDLE) {
            if (viewHolder instanceof ToDoAdapter.ViewHolder) {
                ToDoAdapter.ViewHolder myViewHolder = (ToDoAdapter.ViewHolder)viewHolder;
    ...
    public interface RecyclerViewRowTouchHelperContract {
        ...
        void onRowSelected(ToDoAdapter.ViewHolder myViewHolder);
        void onRowClear(ToDoAdapter.ViewHolder myViewHolder);
    }
}
